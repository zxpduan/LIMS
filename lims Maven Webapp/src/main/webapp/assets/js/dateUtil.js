...
var DateUtil = function(){
  ...
  //+---------------------------------------------------
  //| 求两个时间的天数差 日期格式为 YYYY-MM-dd,返回天数是正值
  //+---------------------------------------------------
  ...
  //+---------------------------------------------------
    //| 求两个时间的天数差 日期格式为 YYYY-MM-dd,返回天数是正负值
    //+---------------------------------------------------
      this.daysBetween3=function(DateOne,DateTwo)
  	  {
  ...
  //+---------------------------------------------------
    ...
    //+---------------------------------------------------
      this.daysBetween2=function(DateOne,DateTwo)
  	  {
